...
<html>
    ...
    <body>
        ...
        <center><h1 class="display-4">ADD A TASK TO YOUR TO-DO LIST</h1>
        <p>Enter details regarding the task to be entered in the to-do list.</p>
        <form action="AddTaskServlet" method="post">
            <input type="number" class="form-control" name="id" placeholder="Enter serial number." required/>
            <input type="text" class="form-control" name="task" placeholder="Enter the task description" required/>
